...
register_block {
  ...
  register {
    ...
    bit_field { name 'bit_field_2'; bit_assignment lsb: 16, width: 4; type :rohw; initial_value 0    }
    bit_field { name 'bit_field_3'; bit_assignment lsb: 20, width: 4; type :rohw; initial_value 0; reference 'register_3.bit_field_3' }
